...
var WalletUTXOBySatoshis = models.WalletUTXOBySatoshis;

describe('Wallet UTXO By Satoshis Model', function() {
  ...
  describe('@constructor', function() {
    it('with hex strings', function() {
      var utxo = new WalletUTXOBySatoshis('b4f97411dadf3882296997ade99f4a0891b07e768a76898b837ac41d2c2622e7', {
    ...
    it('with hex strings', function() {
      var utxo = WalletUTXOBySatoshis('b4f97411dadf3882296997ade99f4a0891b07e768a76898b837ac41d2c2622e7', {
        address: 'mrU9pEmAx26HcbKVrABvgL7AwA5fjNFoDc',
        satoshis: 300000,
        txid: '5dde1b67c1a1dbc459f56a71efcedbd06c9516c51a9f901067253341175615bc',
        index: 3,
    ...
    it('with buffers', function() {
      var utxo = new WalletUTXOBySatoshis(walletId, {
        address: 'mrU9pEmAx26HcbKVrABvgL7AwA5fjNFoDc',
        satoshis: 300000,
    ...
    it('with hex strings', function() {
      var utxo = WalletUTXOBySatoshis.create('b4f97411dadf3882296997ade99f4a0891b07e768a76898b837ac41d2c2622e7', {
        address: 'mrU9pEmAx26HcbKVrABvgL7AwA5fjNFoDc',
        satoshis: 300000,
        txid: '5dde1b67c1a1dbc459f56a71efcedbd06c9516c51a9f901067253341175615bc',
        index: 3,
  ...
  describe('#getKey', function() {
    it('will get the correct key', function() {
      ...
      expectedKey += '41124f8000000000'; // satoshis
  ...
  describe('@getKey', function() {
    it('will get the correct key', function() {
      ...
      var key = WalletUTXOBySatoshis.getKey(walletId, 300000, txid, 3, 'hex');
      var expectedKey = 'b4f97411dadf3882296997ade99f4a0891b07e768a76898b837ac41d2c2622e7';
      expectedKey += '41124f8000000000';
